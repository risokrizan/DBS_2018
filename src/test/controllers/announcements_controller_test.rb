...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { author: @announcement.author, date: @announcement.date, text: @announcement.text } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { author: @announcement.author, date: @announcement.date, text: @announcement.text } }
