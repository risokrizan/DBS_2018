...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { bank_name: @bank.bank_name, city: @bank.city, estabilished_date: @bank.estabilished_date, street: @bank.street } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { bank_name: @bank.bank_name, city: @bank.city, estabilished_date: @bank.estabilished_date, street: @bank.street } }
