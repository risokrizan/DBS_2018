...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { cpu_clock: @computer.cpu_clock, cpu_cores: @computer.cpu_cores, cpu_name: @computer.cpu_name, gpu_clock: @computer.gpu_clock, gpu_cores: @computer.gpu_cores, gpu_name: @computer.gpu_name } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { cpu_clock: @computer.cpu_clock, cpu_cores: @computer.cpu_cores, cpu_name: @computer.cpu_name, gpu_clock: @computer.gpu_clock, gpu_cores: @computer.gpu_cores, gpu_name: @computer.gpu_name } }
